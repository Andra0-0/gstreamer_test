...
static void gst_rgavideoconvert_set_property (GObject * object,
    guint property_id, const GValue * value, GParamSpec * pspec);
static void gst_rgavideoconvert_get_property (GObject * object,
...
static gboolean gst_rgavideoconvert_set_info (GstVideoFilter * filter, GstCaps * incaps,
    GstVideoInfo * in_info, GstCaps * outcaps, GstVideoInfo * out_info);
static GstFlowReturn gst_rgavideoconvert_transform_frame (GstVideoFilter * filter,
    GstVideoFrame * inframe, GstVideoFrame * outframe);
static GstFlowReturn gst_rgavideoconvert_transform_frame_ip (GstVideoFilter * filter,
    GstVideoFrame * frame);
...
G_DEFINE_TYPE_WITH_CODE (GstRgavideoconvert, gst_rgavideoconvert, GST_TYPE_VIDEO_FILTER,
  GST_DEBUG_CATEGORY_INIT (gst_rgavideoconvert_debug_category, "rgavideoconvert", 0,
  "debug category for rgavideoconvert element"));

static void
gst_rgavideoconvert_class_init (GstRgavideoconvertClass * klass)
{
  ...
  video_filter_class->set_info = GST_DEBUG_FUNCPTR (gst_rgavideoconvert_set_info);
  video_filter_class->transform_frame = GST_DEBUG_FUNCPTR (gst_rgavideoconvert_transform_frame);
  video_filter_class->transform_frame_ip = GST_DEBUG_FUNCPTR (gst_rgavideoconvert_transform_frame_ip);

}

static void
gst_rgavideoconvert_init (GstRgavideoconvert *rgavideoconvert)
{
}

void
gst_rgavideoconvert_set_property (GObject * object, guint property_id,
...
void
gst_rgavideoconvert_get_property (GObject * object, guint property_id,
...
void
gst_rgavideoconvert_dispose (GObject * object)
{
  GstRgavideoconvert *rgavideoconvert = GST_RGAVIDEOCONVERT (object);
...
void
gst_rgavideoconvert_finalize (GObject * object)
{
  GstRgavideoconvert *rgavideoconvert = GST_RGAVIDEOCONVERT (object);
...
static gboolean
gst_rgavideoconvert_start (GstBaseTransform * trans)
{
...
static gboolean
gst_rgavideoconvert_stop (GstBaseTransform * trans)
{
  GstRgavideoconvert *rgavideoconvert = GST_RGAVIDEOCONVERT (trans);
...
static gboolean
gst_rgavideoconvert_set_info (GstVideoFilter * filter, GstCaps * incaps,
    GstVideoInfo * in_info, GstCaps * outcaps, GstVideoInfo * out_info)
{
  GstRgavideoconvert *rgavideoconvert = GST_RGAVIDEOCONVERT (filter);
...
gst_rgavideoconvert_transform_frame (GstVideoFilter * filter, GstVideoFrame * inframe,
...
static GstFlowReturn
gst_rgavideoconvert_transform_frame_ip (GstVideoFilter * filter, GstVideoFrame * frame)
{
  GstRgavideoconvert *rgavideoconvert = GST_RGAVIDEOCONVERT (filter);

  GST_DEBUG_OBJECT (rgavideoconvert, "transform_frame_ip");
...
#endif
#ifndef PACKAGE
#define PACKAGE "rgavideoconvert"
#endif
#ifndef PACKAGE_NAME
#define PACKAGE_NAME "RgaVideoConvert"
#endif
